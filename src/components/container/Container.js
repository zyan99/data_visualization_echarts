...
export default class Container extends Component {
  ...
  componentDidMount() {
    // 获取统计数据
    axios
      .get("/data/count-data.json")
      .then((res) => {
        // console.log(res.data);
        this.setState({
          listed_companies_total: res.data.listed_companies_total,
        }); // 上市公司数
        this.setState({
          listed_securities_total: res.data.listed_securities_total,
        }); // 上市证券数
        this.setState({ total_market_value: res.data.total_market_value }); // 股票总市值
        this.setState({
          circulation_market_value: res.data.circulation_market_value,
        }); // 股票流通市值
    ...
    const rankChartOpt = {
      tooltip: {
        ...
        formatter: function (params) {
          ...
          const suffix =
            '<span sytle="margin-left:5px;font-size:12px;">亿元</span>';
          return (
            param.name +
            "<br />" +
            marker +
    ...
    axios.get("data/ranking-list.json").then((res) => {
      $rankChart.classList.add("chart_done");
      let data = res.data;
      const xData = [];
      const yData = [];
      for (let i in data) {
    ...
    const mapChart = echarts.init($mapChart);
    const mapChartOpt = {
      tooltip: {
        formatter: function (params) {
    ...
    axios
      .get("data/region-count.json")
      .then((res) => {
        $mapChart.classList.add("chart_done");
        let data = res.data;
        // console.log(data);
        const chartData = [];
        for (let i in data) {
    ...
    axios.get("/data/month-count.json").then((res) => {
      $trendChart.classList.add("chart_done");
      let data = res.data;
      const xData = [];
      const yData1 = [];
      const yData2 = [];
    ...
    axios.get("/data/csrc-industry.json").then((res) => {
      $csrcChart.classList.add("chart_done");
      let data = res.data;
      const chartData = [];
      for (let i in data) {
        chartData.push({
      ...
      <div id="container">
        <div id="flexCon">
          <div className="flex_row">
            <div className="flex_cell flex_cell_l">
              <div className="chart_wrapper">
                <h3 className="chart_title">市价总值排行Top10</h3>
                <div className="chart_div" id="rankChart">
            ...
            <div className="flex_cell flex_cell_c" style={{ paddingRight: 0 }}>
              <div className="chart_wrapper">
                <h3 className="chart_title">统计数据</h3>
                <div className="chart_div chart_done">
                  <table className="data-t">
                    <tbody>
                      <tr>
                        <th>
                          <img alt="" src="img/icon-01.png" />
                        </th>
                        <td>
                          <p>
                            <span id="listedCompany">
                              <CountUp
                                end={this.state.listed_companies_total}
                              ></CountUp>
                            </span>
                          </p>
                          <p>上市公司数</p>
                        ...
                        <th>
                          <img alt="" src="img/icon-02.png" />
                        </th>
                        <td>
                          <p>
                            <span id="listedCompany">
                              <CountUp
                                end={this.state.listed_securities_total}
                              ></CountUp>
                            </span>
                          </p>
                          <p>上市证券数</p>
                      ...
                      <tr>
                        <th>
                          <img alt="" src="img/icon-03.png" />
                        </th>
                        <td>
                          <p>
                            <span id="listedCompany">
                              <CountUp
                                end={this.state.total_market_value}
                              ></CountUp>
                            </span>
                          </p>
                          <p>股票总市值（亿元）</p>
                        ...
                        <th>
                          <img alt="" src="img/icon-04.png" />
                        </th>
                        <td>
                          <p>
                            <span id="listedCompany">
                              <CountUp
                                end={this.state.circulation_market_value}
                              ></CountUp>
                            </span>
                          </p>
                          <p>股票流通市值（亿元）</p>
                      ...
                      <tr>
                        <th>
                          <img alt="" src="img/icon-05.png" />
                        </th>
                        <td>
                          <p>
                            <span id="listedCompany">
                              <CountUp end={this.state.sh_pe_ratio}></CountUp>
                            </span>
                          </p>
                          <p>上市平均市盈率</p>
                        </td>
                        <th>
                          <img alt="" src="img/icon-06.png" />
                        </th>
                        <td>
                          <p>
                            <span id="listedCompany">
                              <CountUp end={this.state.sz_pe_ratio}></CountUp>
                            </span>
                          </p>
                          <p>深市平均市盈率</p>
                        </td>
            ...
            <div className="flex_cell flex_cell_r" style={{ paddingLeft: 0 }}>
              <div className="chart_wrapper">
                <h3 className="chart_title">上市公司地域分布</h3>
                <div className="chart_div" id="mapChart">
                  <div className="chart_loader">
                    <div className="loader"></div>
                  </div>
                </div>
          ...
          <div className="flex_row">
            <div
              className="flex_cell flex_cell_lc"
              style={{ paddingBottom: 0 }}
            >
              <div className="chart_wrapper">
                <h3 className="chart_title">2018年月度股票情况及预测</h3>
                <div className="chart_div" id="trendChart">
                  <div className="chart_loader">
                    <div className="loader"></div>
                  </div>
                </div>
            ...
            <div className="flex_cell flex_cell_r" style={{ paddingBottom: 0 }}>
              <div className="chart_wrapper">
                <h3 className="chart_title">CSRC行业分类</h3>
                <div className="chart_div" id="csrcChart">
                  <div className="chart_loader">
                    <div className="loader"></div>
                  </div>
                </div>
